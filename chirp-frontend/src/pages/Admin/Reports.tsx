...
import { Loader2, CheckCircle, ChevronDown, AlertTriangle, User, MessageSquare, Shield, Trash2, Ban, Clock, X, ShieldOff, UserX, Check } from 'lucide-react';
...
export default function AdminReports() {
  ...
  const isUserReport = report?.reportable_type?.includes('User');
